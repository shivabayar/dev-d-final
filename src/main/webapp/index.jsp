		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">Large menu <b class="caret"></b></a>
				...
				<ul class="nav navbar-nav navbar-right not-nav">
										...
										<ul>
											...
											<li><a href="#"> <img src="images/avatar_50.jpg"
													alt="avatar" /><span class="date pull-right">20
														Oct.</span><span class="name">Adam</span> is now following you
											</a></li>
					...
					<li class="button"><a href="javascript:;"
						class="speech-button"><i class="fa fa-microphone"></i></a></li>
				</ul>
				...
				<div class="menu-space">
					<div class="content">
						<div class="side-user">
							...
							<div class="info">
								<a href="#">Shivraj</a> <img src="images/state_online.png"
									alt="Status" /> <span>Online</span>
							</div>
						</div>
