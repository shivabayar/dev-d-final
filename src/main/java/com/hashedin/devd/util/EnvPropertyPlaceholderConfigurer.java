package com.hashedin.devd.util;
...
/**
 *
 * Replaces ${} variables in Spring Framework's ApplicationContext.xml and
 * <servlet-name>-servlet.xml with environment specific (i.e. Machine specific)
 * properties
 *
 *
 * This allows you to have a different configuration on a per-machine basis.
 *
 * The substitution variables are picked up from EnvironmentInfo class. By
 * default, EnvironmentInfo looks for a file
 * /environment/<machinename>.properties in the classpath.
 *
 * @see http://forum.springframework.org/showthread.php?t=29472
 * @see http
 *      ://static.springframework.org/spring/docs/2.0.x/api/org/springframework
